...
#define ORIGINAL_FILE_NAME "UE4Editor-GameProgramming2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME GameProgramming2
#define DEPRECATED_FORGAME DEPRECATED
#define GAMEPROGRAMMING2_API DLLEXPORT
